...
FOUNDING = {
    ...
    'bía neuroscience': (2021, 'M'),  # raw "Bía Neuroscience" — must keep í for lookup
    ...
    'cognixion®': (2014, 'M'),
    'neurophet': (2016, 'L'),
    'ōura': (2013, 'H'),  # raw "ŌURA" — must use lowercase macron-o for lookup
    'positrigo': (2018, 'M'),
    'machinemd': (2019, 'L'),
    'iconeus': (2011, 'M'),
    'digilens': (2003, 'M'),
    ...
    # ---- Round 2 batch 1 (2026-04-09, v0.1.3) — T-Z + early A ----
    'tneurodx': (2018, 'M'),
    'tibtimeisbrain': (2020, 'H'),
    'trainfes': (2013, 'H'),
    'tripp inc.': (2016, 'M'),
    'turingmedical': (2019, 'H'),
    'ubiquityvx': (2022, 'M'),
    'ucat inc.': (2023, 'M'),
    'uneeg medical': (2005, 'H'),
    'universal-brain': (2022, 'H'),
    'velentium medical': (2012, 'M'),
    'viewmind': (2018, 'L'),
    'vthera': (2015, 'H'),
    'virtuleap': (2018, 'H'),
    'vital connect': (2011, 'H'),
    'vital start health inc.': (2017, 'M'),
    'viv labs': (2025, 'L'),
    'wavepaths': (2019, 'H'),
    'waya health': (2016, 'M'),
    'wearable devices ltd': (2014, 'H'),
    'xanastim': (2021, 'H'),
    'xii medical': (2017, 'H'),
    'xylo bio': (2021, 'H'),
    'yneuro': (2019, 'M'),
    ...
    'zeta': (2018, 'H'),
    'zyphra': (2020, 'M'),
    'axon interfaces': (2022, 'H'),
    'avrwell': (2024, 'M'),
    'australis scientific': (2021, 'M'),
    'aural analytics': (2015, 'H'),
    # ---- Round 2 batch 2 (2026-04-09, v0.1.3) ----
    'audicin': (2022, 'H'),
    'atlas': (2013, 'H'),
    'ai-stroke': (2022, 'H'),
    'neurox': (2024, 'H'),
    ...
    'neuroem': (2013, 'H'),
    'nudge': (2024, 'H'),
    'graymatters health': (2018, 'H'),
    'nuro inc': (2016, 'H'),
    'juniper biomedical': (2019, 'H'),
    'neurotype inc.': (2019, 'H'),
    'comphya': (2017, 'H'),
    'neuros medical': (2008, 'H'),
    'evrenvns': (2018, 'H'),
    'ruten': (2023, 'H'),
    'thynk': (2022, 'M'),
    'aurenar': (2023, 'H'),
    'sora neuroscience': (2020, 'H'),
    'cns fund': (2023, 'M'),  # rebrand of Joy Ventures → Corundum Neuroscience
    'arctop inc.': (2016, 'H'),
    'ability neuro inc.': (2025, 'H'),  # Wyss Geneva spinoff
    'spinex': (2018, 'H'),
    'vivatronix': (2025, 'H'),
    'neurodiscovery ai': (2023, 'H'),
    'nmtc1': (2009, 'M'),  # same as NeuroOne Medical (already keyed) — duplicate row in reccy
    'epineuron': (2016, 'H'),
    'axo': (2025, 'H'),  # Axo Neurotech (re-added; was removed in v0.1.1 fuzzy fix)
    'aurimod': (2015, 'H'),
    'avivomed': (2021, 'M'),
    'sona': (2021, 'M'),
    'neurosigma': (2008, 'H'),
    # ---- Round 2 batch 3 (2026-04-09, v0.1.3) ----
    'kandu': (2022, 'M'),  # Kandu Health (founded 2022); merged with Neurolutions 2025
    'ohmbody': (2025, 'M'),  # division of Spark Biomedical
    'openwater': (2016, 'H'),
    'braingrade': (2019, 'H'),
    'lyeons neurotech': (2024, 'H'),
    'cognision': (2003, 'M'),
    'esper': (2019, 'H'),  # Esper Bionics
    'neo-bionica': (2021, 'H'),
    'resonant link medical': (2017, 'M'),
    'sevaro health, inc': (2019, 'M'),
    'brainbit': (2015, 'M'),
    'cerevia': (2025, 'H'),  # Cerevia Neurosciences (Rockville, MD) — reccy says France, see discrepancies
    'wearable devices': (2014, 'H'),
    'sooma medical': (2013, 'H'),
    'biotronik neuro': (2023, 'H'),  # Biotronik's neuro spinoff/division
    'neuronic': (2021, 'H'),
    'brain technologies, inc.': (2018, 'M'),  # = Brain.Space, Israel
    'nervonik, inc.': (2020, 'H'),
    'neurosom': (2021, 'M'),
    'neuraworx': (2021, 'M'),
...
SOURCES = {
    ...
    # ---- Round 2 batch 1 (2026-04-09, v0.1.3) ----
    'tneurodx': 'https://pitchbook.com/profiles/company/436390-75',
    'tibtimeisbrain': 'https://eithealth.eu/news-article/spanish-startup-time-is-brain-wins-european-eit-health-catapult-competition/',
    'trainfes': 'https://www.crunchbase.com/organization/trainfes',
    'tripp inc.': 'https://www.crunchbase.com/organization/tripp',
    'turingmedical': 'https://www.crunchbase.com/organization/nous-imaging',
    'ubiquityvx': 'https://tracxn.com/d/companies/ubiquityvx/__2PWOJrBpmklecwH1eWHFLpDk60f0CIa_GUZNb6HzJ14',
    'ucat inc.': 'https://www.cartersciences.com/interviews/tag/uCat',
    'uneeg medical': 'https://pitchbook.com/profiles/company/493598-71',
    'universal-brain': 'https://pulse2.com/universal-brain-profile-dr-kazu-okuda-interview/',
    'velentium medical': 'https://pitchbook.com/profiles/company/311336-38',
    'viewmind': 'https://pitchbook.com/profiles/company/435085-12',
    'vthera': 'https://www.crunchbase.com/organization/virtual-therapeutics',
    'virtuleap': 'https://via.news/2019/12/06/virtuleap-diving-into-vr-brain-training/',
    'vital connect': 'https://www.crunchbase.com/organization/vital-connect',
    'vital start health inc.': 'https://jhf.org/news/how-vital-start-is-transforming-mental-health-care-from-postpartum-struggles-to-vr-healing',
    'viv labs': 'https://tracxn.com/d/legal-entities/india/vivatronix-technologies-private-limited/__EXESrkClPMLLYEcvKO748nTrBr9y4yAYmU0-UBfMtXs',
    'wavepaths': 'https://www.imperial.ac.uk/news/197655/startup-profile-wavepaths/',
    'waya health': 'https://www.crunchbase.com/organization/waya-health',
    'wearable devices ltd': 'https://www.sec.gov/Archives/edgar/data/1887673/000121390022008340/ea155863-f1_wearabledev.htm',
    'xanastim': 'https://yellowpages.swiss/location.cfm?key=2523612&company=XanaStim-Sarl&art=HRB',
    'xii medical': 'https://pitchbook.com/profiles/company/339813-55',
    'xylo bio': 'https://pitchbook.com/profiles/company/481978-54',
    'yneuro': 'https://vivatech.com/news/yneuro-s-viva-tech-growth-story-brainwaves-to-business',
    'zander labs': 'https://www.crunchbase.com/organization/zander-labs',
    'zeta': 'https://en.wikipedia.org/wiki/Zeta_Surgical',
    'zyphra': 'https://pitchbook.com/profiles/company/437883-40',
    'axon interfaces': 'https://www.crunchbase.com/organization/axon-interfaces',
    'avrwell': 'https://www.avrwell.com/aboutus',
    'australis scientific': 'https://pitchbook.com/profiles/company/597613-06',
    'aural analytics': 'https://www.crunchbase.com/organization/aural-analytics',
    # ---- Round 2 batch 2 (2026-04-09, v0.1.3) ----
    'audicin': 'https://pitchbook.com/profiles/company/512956-54',
    'atlas': 'https://www.crunchbase.com/organization/atlas',
    'ai-stroke': 'https://www.crunchbase.com/organization/ai-stroke',
    'neurox': 'https://find-and-update.company-information.service.gov.uk/company/15537848',
    'wise neuro': 'https://www.crunchbase.com/organization/wise-s-r-l',
    'neuroem': 'https://www.crunchbase.com/organization/neuroem',
    'nudge': 'https://x.com/FEhrsam/status/1820859394361610338',
    'graymatters health': 'https://www.crunchbase.com/organization/graymatters-health',
    'nuro inc': 'https://www.crunchbase.com/organization/nuro-corp',
    'juniper biomedical': 'https://www.crunchbase.com/organization/rbi-medical',
    'neurotype inc.': 'https://www.crunchbase.com/organization/neurotype-inc',
    'comphya': 'https://comphya.com/about',
    'neuros medical': 'https://www.crunchbase.com/organization/neuros-medical',
    'evrenvns': 'https://www.crunchbase.com/organization/evren-technologies',
    'ruten': 'https://www.crunchbase.com/organization/ruten-3ba5',
    'thynk': 'https://www.cbinsights.com/company/thynk',
    'aurenar': 'https://pitchbook.com/profiles/company/711593-38',
    'sora neuroscience': 'https://www.crunchbase.com/organization/sora-neuroscience',
    'cns fund': 'https://www.prnewswire.com/il/news-releases/joy-ventures-rebrands-as-corundum-neuroscience-launching-new-venture-builder-and-fund-to-spur-neuroscience-technology-innovation-301981530.html',
    'arctop inc.': 'https://www.cbinsights.com/company/arctop',
    'ability neuro inc.': 'https://www.businesswire.com/news/home/20250611125604/en/Craig-Cook-appointed-Chief-Business-Officer-and-Co-founder-at-ABILITY-Neurotech-the-Wyss-Genevas-flagship-spin-off',
    'spinex': 'https://www.globenewswire.com/en/news-release/2019/01/03/1679942/0/en/SpineX-Launches-to-Develop-Non-Invasive-Neuromodulation-Devices-to-Address-a-Range-of-Medical-Conditions.html',
    'vivatronix': 'https://www.indiafilings.com/search/vivatronix-technologies-private-limited-cin-U46497KA2025PTC197325',
    'neurodiscovery ai': 'https://www.crunchbase.com/organization/neurodiscovery-ai',
    'nmtc1': 'https://pitchbook.com/profiles/company/168700-24',
    'epineuron': 'https://www.crunchbase.com/organization/epineuron-technologies',
    'axo': 'https://x.com/StealthCoSpy/status/1980393595682320774',
    'aurimod': 'https://pitchbook.com/profiles/company/264992-86',
    'avivomed': 'https://www.crunchbase.com/organization/avivomed',
    'sona': 'https://pitchbook.com/profiles/company/471320-65',
    'neurosigma': 'https://www.neurosigma.com/',
    # ---- Round 2 batch 3 (2026-04-09, v0.1.3) ----
    'kandu': 'https://kandu.com/',
    'ohmbody': 'https://www.ohmbody.com/',
    'openwater': 'https://www.openwater.health/',
    'braingrade': 'https://www.braingrade.io/',
    'lyeons neurotech': 'https://lyeons.com/',
    'cognision': 'https://www.cognision.com/',
    'esper': 'https://www.esperbionics.com/',
    'neo-bionica': 'https://neo-bionica.com/',
    'resonant link medical': 'https://www.rlmedical.com/',
    'sevaro health, inc': 'https://sevaro.com/',
    'brainbit': 'https://brainbit.com/',
    'cerevia': 'https://cerevia.care/',
    'wearable devices': 'https://www.wearabledevices.co.il/',
    'sooma medical': 'https://soomamedical.com/',
    'biotronik neuro': 'https://info.biotronik.com/neuro',
    'neuronic': 'https://www.neuronic.online/',
    'brain technologies, inc.': 'https://www.brain.space/',
    'nervonik, inc.': 'https://nervonik.com/',
    ...
    'somnair sleep': 'https://www.somnairsleep.com/',
    'vonova': 'https://www.vonova.io/',
